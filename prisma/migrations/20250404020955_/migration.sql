-- CreateEnum
CREATE TYPE "SexType" AS ENUM ('Male', 'Female', 'Unisex');
...
CREATE TABLE "Category" (
    ...
    "billboardMaleId" TEXT,
    "billboardFemaleId" TEXT,
    "storeId" TEXT NOT NULL,
...
CREATE TABLE "Product" (
    ...
    "sex" "SexType" NOT NULL,
    "existingProduct" BOOLEAN NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Category" ADD CONSTRAINT "Category_billboardMaleId_fkey" FOREIGN KEY ("billboardMaleId") REFERENCES "Billboard"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Category" ADD CONSTRAINT "Category_billboardFemaleId_fkey" FOREIGN KEY ("billboardFemaleId") REFERENCES "Billboard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
